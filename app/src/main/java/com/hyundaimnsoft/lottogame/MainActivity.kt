package com.hyundaimnsoft.lottogame
...
import com.hyundaimnsoft.lottogame.*
...
class MainActivity : AppCompatActivity() {
    ...
    private var mItemSelectedListener = object : AdapterView.OnItemSelectedListener{
        override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
            onFirstGameItemSelect(parent,position)
            onSecondGameItemSelect(parent,position)
            onThirdGameItemSelect(parent,position)
            onFourthGameItemSelect(parent,position)
            onFifthGameItemSelect(parent,position)
        }
    ...
    private fun setButton(){
        ...
        second_random.setOnClickListener {
            ...
            setRandomNumber(second_number1,mSecondGameNumbers,0,second_random)
            setRandomNumber(second_number2,mSecondGameNumbers,100,second_random)
            setRandomNumber(second_number3,mSecondGameNumbers,200,second_random)
            setRandomNumber(second_number4,mSecondGameNumbers,300,second_random)
            setRandomNumber(second_number5,mSecondGameNumbers,400,second_random)
            setRandomNumber(second_number6,mSecondGameNumbers,500,second_random)
        }

        third_random.setOnClickListener {
            third_random.isEnabled = false
            mThirdGameNumbers.clear()
            setRandomNumber(third_number1,mThirdGameNumbers,0,third_random)
            setRandomNumber(third_number2,mThirdGameNumbers,100,third_random)
            setRandomNumber(third_number3,mThirdGameNumbers,200,third_random)
            setRandomNumber(third_number4,mThirdGameNumbers,300,third_random)
            setRandomNumber(third_number5,mThirdGameNumbers,400,third_random)
            setRandomNumber(third_number6,mThirdGameNumbers,500,third_random)
        }

        fourth_random.setOnClickListener {
            fourth_random.isEnabled = false
            mFourthGameNumbers.clear()
            setRandomNumber(fourth_number1,mFourthGameNumbers,0,fourth_random)
            setRandomNumber(fourth_number2,mFourthGameNumbers,100,fourth_random)
            setRandomNumber(fourth_number3,mFourthGameNumbers,200,fourth_random)
            setRandomNumber(fourth_number4,mFourthGameNumbers,300,fourth_random)
            setRandomNumber(fourth_number5,mFourthGameNumbers,400,fourth_random)
            setRandomNumber(fourth_number6,mFourthGameNumbers,500,fourth_random)
        }

        fifth_random.setOnClickListener {
            fifth_random.isEnabled = false
            mFifthGameNumbers.clear()
            setRandomNumber(fifth_number1,mFifthGameNumbers,0,fifth_random)
            setRandomNumber(fifth_number2,mFifthGameNumbers,100,fifth_random)
            setRandomNumber(fifth_number3,mFifthGameNumbers,200,fifth_random)
            setRandomNumber(fifth_number4,mFifthGameNumbers,300,fifth_random)
            setRandomNumber(fifth_number5,mFifthGameNumbers,400,fifth_random)
            setRandomNumber(fifth_number6,mFifthGameNumbers,500,fifth_random)
        }
        ...
        result_button.setOnClickListener (object : View.OnClickListener{
            ...
            override fun onClick(v: View){
                ...
                if(isAllSelected){
                    win_text.text=
                        ("당첨 번호 : "+mWinNumbers[0] + " "+mWinNumbers[1]+ " "+mWinNumbers[2]+ " "+mWinNumbers[3]
                                + " "+mWinNumbers[4]+ " "+mWinNumbers[5]+" 보너스: "+mBonusNum)
    ...
    private fun onFirstGameItemSelect(parent: AdapterView<*>, position: Int){
        var selectedNumber = Integer.parseInt(parent.getItemAtPosition(position) as String)
        when (parent.id){
    ...
    private fun onSecondGameItemSelect(parent: AdapterView<*>, position: Int){
        var selectedNumber = Integer.parseInt(parent.getItemAtPosition(position) as String)
        when (parent.id){
    ...
    private fun onThirdGameItemSelect(parent: AdapterView<*>, position: Int){
        var selectedNumber = Integer.parseInt(parent.getItemAtPosition(position) as String)
        when (parent.id){
    ...
    private fun onFourthGameItemSelect(parent: AdapterView<*>, position: Int){
        var selectedNumber = Integer.parseInt(parent.getItemAtPosition(position) as String)
        when (parent.id){
    ...
    private fun onFifthGameItemSelect(parent: AdapterView<*>, position: Int){
        var selectedNumber = Integer.parseInt(parent.getItemAtPosition(position) as String)
        when (parent.id){
    ...
    private fun getRandomNumber(gemeNumbers: Map<Int,Int>):Int {
        val generator = Random()
        var num = generator.nextInt(45)+1
        while (isDuplication(gemeNumbers,num)){
